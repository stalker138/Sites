...
$pb_domain='https://teohim.kg';	// Имя домена. Используется при формировании sitemap.xml
...
$pb_path_main=$pb_path_root.'a_kg17/';					// Корневая папка Vcorp generator (VPB - Vcorp pages builder)
...
$pba_subst = array('-kg', 'Киргизия', 'Киргизии', '', '', '', '');
