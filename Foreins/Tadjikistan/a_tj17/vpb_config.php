...
$pb_domain='http://teohim.tj';	// Имя домена. Используется при формировании sitemap.xml
...
$pb_path_main=$pb_path_root.'a_tj17/';					// Корневая папка Vcorp generator (VPB - Vcorp pages builder)
...
$pba_subst = array('-tj', 'Таджикистан', 'Таджикистане', '', '', '', '');
