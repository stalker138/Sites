...
$pb_domain='https://teohim.am';	// Имя домена. Используется при формировании sitemap.xml
...
$pb_path_main=$pb_path_root.'a_m17/';					// Корневая папка Vcorp generator (VPB - Vcorp pages builder)
...
$pba_subst = array('-am', 'Армения', 'Армении', '', '', '', '');
