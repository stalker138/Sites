...
$pb_domain='https://teohim.uz';	// Имя домена. Используется при формировании sitemap.xml
...
$pb_path_main=$pb_path_root.'a_uz17/';					// Корневая папка Vcorp generator (VPB - Vcorp pages builder)
...
$pba_subst = array('-uz', 'Узбекистан', 'Узбекистане', '', '', '', '');
