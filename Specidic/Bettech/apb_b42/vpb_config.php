...
$pb_domain='https://www.bettech.kz';	// Имя домена. Используется при формировании sitemap.xml
...
$pba_login[]='b42'; $pba_pass[]='b42'; $pba_name[]='Администратор';		//	adm
$pba_login[]='st321'; $pba_pass[]='st321'; $pba_name[]='st';			//	Алексей
$pba_login[]='e24'; $pba_pass[]='e24'; $pba_name[]='ev';				//	Евгений
$pba_login[]='unk'; $pba_pass[]='btch'; $pba_name[]='ev';				//	Прочие
...
$pb_path_main=$pb_path_root.'apb_b42/';					// Корневая папка Vcorp generator (VPB - Vcorp pages builder)
