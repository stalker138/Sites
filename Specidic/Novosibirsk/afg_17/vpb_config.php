...
$pb_domain='https://www.fg-partner.ru/';	// Имя домена. Используется при формировании sitemap.xml
...
$pba_login[]='fg17'; $pba_pass[]='fg17'; $pba_name[]='Александр';			  	//	Александр
...
$pb_path_main=$pb_path_root.'afg_17/';					// Корневая папка Vcorp generator (VPB - Vcorp pages builder)
