...
$pb_domain='https://teohim-ek.ru';	// Имя домена. Используется при формировании sitemap.xml
...
$pb_path_main=$pb_path_root.'aek_17/';					// Корневая папка Vcorp generator (VPB - Vcorp pages builder)
...
$pba_subst = array('-ek', 'Екатеринбург', 'Екатеринбурге', '', '', '', '');

$pb_autocheck=false;	// Если true, то по-умолчанию исходный код элементов проверяется на недопустимые включения и ссылки
$pb_titles=true;		// Если true, то по-умолчанию страницы проверяются на совпадение title
