<?php
// (c) Vcorp generator 00.80 beta | 2017 | vcorp.ru

// Конфигурационный файл

$pb_crlf=chr(13).chr(10);

$pb_domain='https://teohim.ru';	// Имя домена. Используется при формировании sitemap.xml
...
$pb_sitemap_start=201; // При изменении перезагрузить админку!!!

// Массивы с логинами-паролями. Может быть сколько угодно пользователей.
$pba_login=false; $pba_pass=false; $pba_name=false;
$pba_login[]='alx22'; $pba_pass[]='Alx09'; $pba_name[]='Александр';			//	Александр
$pba_login[]='evg17'; $pba_pass[]='Ev17'; $pba_name[]='Евгений';			//	Евгений
$pba_login[]='st157'; $pba_pass[]='St157'; $pba_name[]='Алексей';			//	Алексей
$pba_login[]='at157'; $pba_pass[]='ATeo09'; $pba_name[]='Администратор';	//	Администратор
...
$pb_path_main=$pb_path_root.'at_157_nw/';					// Корневая папка Vcorp generator (VPB - Vcorp pages builder)
...
$pba_files=array('p0','p1','p2','p3','p4','p5','p6','p7','tpl','b0','b1','b2','b3','b4','b5','b6','b7','t0','t1','t2','t3','t4','t5');
