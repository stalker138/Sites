...
$pb_domain='https://teohim-belgorod.ru';	// Имя домена. Используется при формировании sitemap.xml
...
$pba_login[]='e17'; $pba_pass[]='e17'; $pba_name[]='Евгений';				//	Евгений
$pba_login[]='st17'; $pba_pass[]='st17'; $pba_name[]='Алексей Стрельников';	//	Алексей Стрельников
$pba_login[]='a17'; $pba_pass[]='a17'; $pba_name[]='Александр';			  	//	Александр
...
$pb_path_main=$pb_path_root.'a_bl17/';					// Корневая папка Vcorp generator (VPB - Vcorp pages builder)
...
// Замена вставок {n} на реальные фразы
$pba_subst = array('-arh', 'Белгород', 'Белгороде', '', '', '', '');
