...
$pb_domain='http://elakor.pro';	// Имя домена. Используется при формировании sitemap.xml
...
$pb_path_main=$pb_path_root.'apro_17/';					// Корневая папка Vcorp generator (VPB - Vcorp pages builder)
