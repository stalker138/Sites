...
include "config.php"; fpb_authorization(0);

?>
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="robots" content="noindex, nofollow"><title>Asw pages builder 00.77 beta 2015</title>
<link rel="stylesheet" href="asw_pb_index_0077.css" type="text/css"/><script type="text/javascript" charset="UTF-8" src="apb_pb_library_0077.js"></script><script type="text/javascript" charset="UTF-8" src="asw_pb_index_0077.js"></script></head><body><div id="main">
<?php
$a1=array(0,0,85,85,85,85,0,0,0,0,0,0,0,0,0); $a2=array('','Open','Add','Copy','Del','Clear','Generation','Enclosure structure','Check of errors','Links to dynamics (id)','Links to statics (href)','Save to backup','Restore from backup','Other operations',($pb_view_info?'Show info':'Hide info'),'Show windows panel');
...
for ($i=0; $i<19; $i++) {
	if ($i<6) $tmp=' style="width:55px;color:#000080;border:solid 1px #000080;'.(($i==0)?'margin-left:0px;background-color:#c8c8c8':'').'"'; else $tmp=($i==6||$i==7||$i==13)?(' style="margin-left:20px;'.(($i==6)?'width:50px;color:#005093;border:solid 1px #005093;':(($i==13)?'color:#006000;border:solid 1px #006000;border-radius:5px;':'')).'"'):(($i>13)?' style="color:#006000;border:solid 1px #006000;border-radius:5px;"':''); $tmp.=' tabIndex="-1" onmouseover="f_hlp(3,'.$i.')" onmouseout="f_hlp()" onclick="f_c_a(3,'.$i.')"';
	$out.='<input id="dta'.$i.'" class="dtarea"'.$tmp.' type="button" tabIndex="-1" value="'.$a1[$i].'"/>';
}
$out.='</div>';
